...
class Exercise8 < Test::Unit::TestCase
  ...
  def test_floating_point_exponential_format
    float_assert( 2.3E+10, "2.3E10", "Failed simple exponential format")
    float_assert( 2.3e+12, "2.3e12", "Failed simple exponential format")
    float_assert( 2.3e+30, "2.3*10^30", "Failed simple exponential format")
  end
